    ...
    for h in http_s :
        for d in open("top-3k-domain.txt",'r'):
            ...
            for hostlist in open("host.txt",'r'):
                ...
                headers = {'Host':host,'User-Agent':'Mozilla/5.0 (Linux; Android 6.0; Nexus 5 Build/MRA58N) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/126.0.0.0 Mobile Safari/537.36'}
                try:
                    r = requests.session()
